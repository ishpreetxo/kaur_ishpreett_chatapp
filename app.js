...
// listen for incoming messages from anyone connected to the chat service and then see what that message is
  socket.on('chat_message', function(msg){ // step1- receive the msg
    console.log(msg);

    // step2- show everyone what was just sent through (send the msg to everyone connected to the service)
